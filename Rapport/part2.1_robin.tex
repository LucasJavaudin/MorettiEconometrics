...
To replace the initial dataset where there is one variable for tickets sold of week 1 to 13 (\textit{entree\_fr1}, ..., \textit{entree\_fr13}), we build a dataset where there is a single variable for tickets sold (\textit{entree\_fr}) but one observation per week.
